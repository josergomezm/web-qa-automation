<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" aria-label="Edit Test Group">
      ...
      <div class="inline-block align-bottom bg-surface rounded-modal text-left overflow-hidden shadow-card-hover transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-surface px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            <!-- Name -->
            <div>
              <label for="edit-group-name" class="block text-sm font-medium text-heading">
            ...
            <!-- Description -->
            <div>
              <label for="edit-group-description" class="block text-sm font-medium text-heading">
